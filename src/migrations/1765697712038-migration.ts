...
export class Migration1765697712038 implements MigrationInterface {
  name = 'Migration1765697712038';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user" ("id" character varying NOT NULL, "login" character varying NOT NULL, "password" character varying NOT NULL, "version" integer NOT NULL DEFAULT '1', "createdAt" bigint NOT NULL DEFAULT '1765697736035', "updatedAt" bigint NOT NULL DEFAULT '1765697736035', CONSTRAINT "UQ_a62473490b3e4578fd683235c5e" UNIQUE ("login"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
  }
